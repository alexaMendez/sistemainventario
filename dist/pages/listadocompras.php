...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0"><?php
                                ...
                                $nombre_pagina = 'Listado-de-Compras';
        ...
        <p>Compras desde <strong><?php echo $fechaInicio; ?></strong> hasta <strong><?php echo $fechaFin; ?></strong></p>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php if (count($compras) > 0): ?>
                    <?php foreach ($compras as $compra): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($compra['nofactura']); ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4">No hay compras registradas en este periodo.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
