# Contributing to technologysolution
...
1. Contribution Requirements :
    * When you contribute, you agree to give a non-exclusive license to technologysolution.io to use that contribution in any context as we (technologysolution.io) see appropriate.
...
2. Installation :
    ...
    * Clone to your machine
    ...
    ```bash
    git clone https://github.com/YOUR_USERNAME/technologysolution.git
    ```
...
- clone the `technologysolution` repo.
