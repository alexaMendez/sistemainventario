...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
  ...
  <div class="sidebar-brand">
    ...
    <a href="./index.html" class="brand-link">
      <!--begin::Brand Image-->
      <img
        src="./assets/img/technologysolutionLogo.png"
        alt="technologysolution Logo"
        class="brand-image opacity-75 shadow"
      />
      <!--end::Brand Image-->
      <!--begin::Brand Text-->
      <span class="brand-text fw-light">technologysolution 4</span>
      <!--end::Brand Text-->
    </a>
    <!--end::Brand Link-->
  </div>
...
<div class="sidebar-brand">
  <a href="./index.html" class="brand-link logo-switch">
    <img
      src="./assets/img/technologysolutionLogo.png"
      alt="technologysolution Logo Small"
      class="brand-image-xl logo-xs opacity-75 shadow"
    />
    <img
      src="./assets/img/technologysolutionFullLogo.png"
      alt="technologysolution Logo Large"
